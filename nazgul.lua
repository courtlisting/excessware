...
NotifyLib.prompt('nazgul - q to lock  - revamped by excess', 'loading..', 5)
NotifyLib.prompt('nazgul - revamped by excess', 'best lock ong - excess', 5)
NotifyLib.prompt('nazgul - revamped by excess', 'excess#0001', 5)
NotifyLib.prompt('game detected: da hood', 'excess#0001', 5)
        Settings = {
        rewrittenmain = {
        Enabled = true,
        Key = "q",
...
local PredictionValue = 0.1142154
    ...
    spawn(function()
        ...
        if Settings.rewrittenmain.DOT == true then
        placemarker.Size = Vector3.new(4, 4, 4), Color3.fromRGB(0, 0, 0)
        else
...
NotifyLib.prompt('nazgul - revamped by excess', 'best lock ong - excess', 5)
NotifyLib.prompt('nazgul - revamped by excess', 'excess#0001', 5)
NotifyLib.prompt('game detected: hood modded', 'excess#0001', 5)
        Settings = {
        rewrittenmain = {
        Enabled = true,
        Key = "q",
...
NotifyLib.prompt('nazgul - revamped by excess', 'best lock ong - excess', 5)
NotifyLib.prompt('nazgul - revamped by excess', 'excess#0001', 5)
NotifyLib.prompt('game detected: untitled hood', 'excess#0001', 5)
        Settings = {
        rewrittenmain = {
        Enabled = true,
        Key = "q",
